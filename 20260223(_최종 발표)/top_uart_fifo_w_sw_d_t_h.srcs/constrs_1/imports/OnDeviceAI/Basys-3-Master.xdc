...
set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports {valid}]
...
set_property -dict { PACKAGE_PIN H2   IOSTANDARD LVCMOS33 } [get_ports trigger];#Sch name = JA9
...
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports dhtio];#Sch name = JB4
